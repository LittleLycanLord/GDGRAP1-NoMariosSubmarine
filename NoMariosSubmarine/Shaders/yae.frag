...
void main() {
    ...
    FragmentColor = vec4(1.0, 1.0, 1.0, 0.5) * (FragmentColor * texture(modelTexture, textureCoordinate));// + (FragmentColor * texture(modelYae, textureCoordinate));
}